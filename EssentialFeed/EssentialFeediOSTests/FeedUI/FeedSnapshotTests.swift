...
class FeedSnapshotTests: XCTestCase {
	...
	func test_feedWithContent() {
		...
		assert(snapshot: sut.snapshot(for: .iPhone8(style: .light, contentSize: .extraExtraExtraLarge)), named: "FEED_WITH_CONTENT_extraExtraExtraLarge")
	}
	...
	func test_feedWithLoadMoreIndicator() {
		...
		assert(snapshot: sut.snapshot(for: .iPhone8(style: .light, contentSize: .extraExtraExtraLarge)), named: "FEED_WITH_LOAD_MORE_INDICATOR_extraExtraExtraLarge")
	}
